...
class Profile(models.Model):
    ...
    resume = models.FileField(null=True, upload_to='./frontend/public/tempdocs/resume',blank=True)
    cover_letter = models.FileField(null=True, upload_to='./frontend/public/tempdocs/coverletter',blank=True)
